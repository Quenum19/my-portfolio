  ...
  experience: [
    {
      ...
      role: l("Stagiaire Assistant Développeur Web", "Web Developer Assistant (Intern)"),
      period: l("Sept 2022 – Juin 2024", "Sept 2022 – June 2024"),
      description: l(
        "Développement et maintenance d'applications web dynamiques.",
        "Development and maintenance of dynamic web applications.",
      ),
      achievements: {
        fr: [
        ...
        en: [
          "Contributed to Fullstack PHP/Laravel development.",
          "Designed complex MySQL databases.",
          "Active participation in Agile/Scrum rituals.",
          "Mentored new interns on best practices.",
          "E-learning content management and maintenance of the Recrulink project.",
        ],
      },
    ...
    },
    {
      ...
      description: l(
        "Développement mobile et maintenance web.",
        "Mobile development and web maintenance.",
      ),
      achievements: {
        fr: [
        ...
        en: [
          "Built a cross-platform mobile app with Ionic.",
